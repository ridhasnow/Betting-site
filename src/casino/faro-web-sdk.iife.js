var GrafanaFaroWebSdk = function(e) {
    ...
    function S(e) {
        return null == e || (l(e) || o(e) ? 0 === e.length : !!u(e) && 0 === Object.keys(e).length)
    }
    function T(e, n) {
        if (e === n)
            return !0;
        if (t(e, "number") && isNaN(e))
            return t(n, "number") && isNaN(n);
        const i = l(e)
          , r = l(n);
        if (i !== r)
            return !1;
    ...
    function M(e=10) {
        return Array.from(Array(e)).map(( () => P[Math.floor(Math.random() * P.length)])).join("")
    }
    const N = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof global ? global : "undefined" != typeof self ? self : void 0;
    function j(e={}) {
        return JSON.stringify(null != e ? e : {}, function() {
            const e = new WeakSet;
            return function(t, n) {
                if (u(n) && null !== n) {
                    if (e.has(n))
    ...
    class R {
        constructor(e, t) {
            var n, i;
            this.signalBuffer = [],
            this.itemLimit = null !== (n = null == t ? void 0 : t.itemLimit) && void 0 !== n ? n : 50,
            this.sendTimeout = null !== (i = null == t ? void 0 : t.sendTimeout) && void 0 !== i ? i : 250,
        ...
        flush() {
            if (this.paused || 0 === this.signalBuffer.length)
                return;
    ...
    (U = e.TransportItemType || (e.TransportItemType = {})).EXCEPTION = "exception",
    U.LOG = "log",
    ...
    function F(e, t, n, i) {
        ...
        ;
        let l;
        (null === (r = n.batching) || void 0 === r ? void 0 : r.enabled) && (l = new R(c,{
        ...
        return {
            add: (...r) => {
                ...
                r.forEach((r => {
                    ...
                    o.some((e => e === r)) ? t.warn(`Transport ${r.name} is already added`) : (r.unpatchedConsole = e,
                    r.internalLogger = t,
                    r.config = n,
                    r.metas = i,
                    o.push(r))
            ...
            execute: e => {
                var i;
                s || ((null === (i = n.batching) || void 0 === i ? void 0 : i.enabled) && (null == l || l.addItem(e)),
                (e => {
                    var i, r;
                    if ((null === (i = n.batching) || void 0 === i ? void 0 : i.enabled) && o.every((e => e.isBatched())))
                        return;
                    const [s] = u([e]);
                    if (void 0 !== s)
                        for (const e of o)
                            t.debug(`Transporting item using ${e.name}\n`, s),
                            e.isBatched() ? (null === (r = n.batching) || void 0 === r ? void 0 : r.enabled) || e.send([s]) : e.send(s)
                }
                )(e))
            }
            ,
            ...
            remove: (...e) => {
                ...
                e.forEach((e => {
                    ...
                    const n = o.indexOf(e);
                    -1 !== n ? o.splice(n, 1) : t.warn(`Transport "${e.name}" is not added`)
                }
                ))
            }
            ,
    ...
    function z(t, n) {
        if (n.preserveOriginalError)
            for (const n of t)
                n.type === e.TransportItemType.EXCEPTION && delete n.payload.originalError;
        return t
    }
    var q;
    e.InternalLoggerLevel = void 0,
    (q = e.InternalLoggerLevel || (e.InternalLoggerLevel = {}))[q.OFF = 0] = "OFF",
    q[q.ERROR = 1] = "ERROR",
    q[q.WARN = 2] = "WARN",
    q[q.INFO = 3] = "INFO",
    ...
    function W(e) {
        var t;
        return H = null !== (t = e.unpatchedConsole) && void 0 !== t ? t : H,
        H
    }
    function K(t=G, n=$) {
        const i = V;
        return n > e.InternalLoggerLevel.OFF && (i.error = n >= e.InternalLoggerLevel.ERROR ? function(...e) {
            t.error(`${i.prefix}\n`, ...e)
        }
        : C,
        i.warn = n >= e.InternalLoggerLevel.WARN ? function(...e) {
            t.warn(`${i.prefix}\n`, ...e)
        }
        : C,
        i.info = n >= e.InternalLoggerLevel.INFO ? function(...e) {
            t.info(`${i.prefix}\n`, ...e)
        }
        : C,
        i.debug = n >= e.InternalLoggerLevel.VERBOSE ? function(...e) {
            t.debug(`${i.prefix}\n`, ...e)
        }
        : C),
        i
    ...
    let X = V;
    function J(e, t) {
        return X = K(e, t.internalLoggerLevel),
        X
    }
    class Z {
        constructor() {
    ...
    function Q(e, t) {
        ...
        const o = (null == r ? void 0 : r.scopeSpans) || []
          , s = (null === (i = null == t ? void 0 : t[0]) || void 0 === i ? void 0 : i.scopeSpans) || [];
    ...
    function ee(t) {
        ...
        return void 0 !== t[0] && (n.meta = t[0].meta),
        t.forEach((t => {
            switch (t.type) {
    ...
    const te = "user-action-start"
      ...
      , re = "user-action-halt";
    const oe = "Error"
      , se = e => e.map((e => u(e) ? j(e) : String(e))).join(" ");
    let ae;
    function ue({internalLogger: t, config: n, metas: i, transports: s, tracesApi: a, actionBuffer: c, getMessage: d}) {
        var f;
        ...
        const g = e => {
          ...
          , {ignoreErrors: m=[], preserveOriginalError: h} = n;
        return g(n.parseStacktrace),
        {
            changeStacktraceParser: g,
            getStacktraceParser: () => ae,
            pushError: (f, {skipDedupe: g, stackFrames: b, type: w, context: y, spanContext: E, timestampOverwriteMs: O, originalError: x}={}) => {
                if (!function(e, t) {
                    ...
                    try {
                        const o = _(Object.assign(Object.assign({}, function(e) {
                            let t = e.cause;
                            v(t) ? t = e.cause.toString() : null !== t && (u(e.cause) || l(e.cause)) ? t = j(e.cause) : null != t && (t = e.cause.toString());
                            return null == t ? {} : {
                                cause: t
                            }
                        }(null != x ? x : f)), null != y ? y : {}))
                        ...
                        (null == (b = null != b ? b : f.stack ? null == ae ? void 0 : ae(f).frames : void 0) ? void 0 : b.length) && (m.payload.stacktrace = {
                            frames: b
                        });
                        const L = {
                            type: m.payload.type,
                            value: m.payload.value,
                            stackTrace: m.payload.stacktrace,
                            context: m.payload.context
                        };
                        if (!g && n.dedupe && !r(p) && T(L, p))
                            return void t.debug("Skipping error push because it is the same as the last one\n", m.payload);
                        p = L,
                        t.debug("Pushing exception\n", m);
                        const C = d();
                        C && C.type === te ? c.addItem(m) : s.execute(m)
                    } catch (e) {
    ...
    function de({apiMessageBus: t, transports: n, config: i}) {
        ...
        t.subscribe((t => {
            if (te !== t.type && re !== t.type) {
                if (t.type === ne) {
                    const {id: i, name: a} = t;
                    return r.flushBuffer((t => {
                        if (function(t, n) {
                            return (null == n ? void 0 : n(t)) || t.type === e.TransportItemType.MEASUREMENT && "web-vitals" === t.payload.type
                        }(t, o))
    ...
    function pe(t, n, i, s, a) {
        ...
        const {actionBuffer: u, getMessage: c} = de({
          ...
          , l = function(t, n, i, r, o) {
            let s;
            return n.debug("Initializing traces API"),
            {
                getOTEL: () => s,
                getTraceContext: () => {
                    const e = null == s ? void 0 : s.trace.getSpanContext(s.context.active());
                    return e ? {
                        trace_id: e.traceId,
                        span_id: e.spanId
                    } : void 0
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, l), ue(d)), function({internalLogger: e, metas: t}) {
            let n, i, r, s;
            ...
            const a = e => {
              ...
              , u = (e, i) => {
                ...
                const o = null == i ? void 0 : i.overrides
                  , s = o ? {
                    overrides: Object.assign(Object.assign({}, null === (r = null == n ? void 0 : n.session) || void 0 === r ? void 0 : r.overrides), o)
                } : {};
                n && t.remove(n),
                n = {
                    session: Object.assign(Object.assign({}, S(e) ? void 0 : e), s)
                },
                t.add(n)
            }
              , c = () => t.value.session
            ...
            return {
                ...
                setView: (e, n) => {
                    var i;
                    if ((null == n ? void 0 : n.overrides) && u(c(), {
                        overrides: n.overrides
                    }),
                    (null === (i = null == r ? void 0 : r.view) || void 0 === i ? void 0 : i.name) === (null == e ? void 0 : e.name))
                        return;
                    const o = r;
                    r = {
                        view: e
                ...
                setPage: e => {
                    var n;
                    const i = o(e) ? Object.assign(Object.assign({}, null !== (n = null == s ? void 0 : s.page) && void 0 !== n ? n : l()), {
                        id: e
                    }) : e;
                    s && t.remove(s),
                    s = {
        ...
        }(d)), function({internalLogger: t, config: n, metas: i, transports: o, tracesApi: s, actionBuffer: a, getMessage: u}) {
            var c;
            t.debug("Initializing logs API");
            let l = null;
            const d = null !== (c = n.logArgsSerializer) && void 0 !== c ? c : ce;
            return {
                pushLog: (c, {context: f, level: p, skipDedupe: g, spanContext: v, timestampOverwriteMs: m}={}) => {
                    try {
                        const h = _(f)
                          , b = {
                        ...
                        if (!g && n.dedupe && !r(l) && T(w, l))
                            return void t.debug("Skipping log push because it is the same as the last one\n", b.payload);
                        l = w,
                        t.debug("Pushing log\n", b);
                        const y = u();
            ...
            let c = null;
            return {
                pushMeasurement: (l, {skipDedupe: d, context: f, spanContext: p, timestampOverwriteMs: g}={}) => {
                    try {
                        const v = _(f)
                          , m = {
                        ...
                        if (!d && n.dedupe && !r(c) && T(h, c))
                            return void t.debug("Skipping measurement push because it is the same as the last one\n", m.payload);
                        c = h,
                        t.debug("Pushing measurement\n", m);
                        const b = u();
                        b && b.type === te ? a.addItem(m) : o.execute(m)
                    } catch (e) {
            ...
            let c = null;
            return {
                pushEvent: (l, d, f, {skipDedupe: p, spanContext: g, timestampOverwriteMs: v, customPayloadTransformer: m=e => e}={}) => {
                    try {
                        const h = _(d)
                          , b = {
                            meta: i.value,
                        ...
                        if (!p && n.dedupe && !r(c) && T(w, c))
                            return void t.debug("Skipping event push because it is the same as the last one\n", b.payload);
                        c = w,
    ...
    function we(t, n, i, r, o, s, a) {
        return n.debug("Initializing Faro"),
        e.faro = {
            api: s,
            config: i,
            instrumentations: a,
        ...
        function(e) {
            if (e.config.preventGlobalExposure)
                ...
                e.config.globalObjectKey in N)
                    return void e.internalLogger.warn(`Skipping global registration due to key "${e.config.globalObjectKey}" being used already. Please set "globalObjectKey" to something else or set "preventGlobalExposure" to "true"`);
                Object.defineProperty(N, e.config.globalObjectKey, {
                    configurable: !1,
                    writable: !1,
                    value: e
                })
    ...
    function ye(e) {
        const t = W(e)
          , n = J(t, e);
        if (be() && !e.isolate)
            return void n.error('Faro is already registered. Either add instrumentations, transports etc. to the global faro instance or use the "isolate" property');
        n.debug("Initializing");
        const i = function(e, t) {
            let n = []
              , i = [];
            const r = () => n.reduce(( (e, t) => Object.assign(e, c(t) ? t() : t)), {})
              , o = () => {
                if (i.length) {
                    const e = r();
                    i.forEach((t => t(e)))
            ...
            return {
                add: (...a) => {
                    ...
                    a.forEach((a => {
                        ...
                        s.some((e => e.name === a.name)) ? t.warn(`Instrumentation ${a.name} is already added`) : (a.unpatchedConsole = e,
                        a.internalLogger = t,
                        a.config = n,
                        a.metas = i,
                        a.transports = r,
                ...
                remove: (...e) => {
                    ...
                    e.forEach((e => {
                        ...
                        const r = s.reduce(( (t, n, i) => null === t && n.name === e.name ? i : null), null);
                        null !== r ? (null === (i = (n = s[r]).destroy) || void 0 === i || i.call(n),
                        s.splice(r, 1)) : t.warn(`Instrumentation "${e.name}" is not added`)
                    }
                    ))
                }
            }
        ...
        return function(e) {
            ...
            const i = {
                ...
                app: {
                    bundleId: e.config.app.name && (r = e.config.app.name,
                    null == N ? void 0 : N[`__faroBundleId_${r}`])
                }
            };
            var r;
            const o = null === (t = e.config.sessionTracking) || void 0 === t ? void 0 : t.session;
            o && e.api.setSession(o),
            e.config.app && (i.app = Object.assign(Object.assign({}, e.config.app), i.app)),
            e.config.user && (i.user = e.config.user),
            e.config.view && (i.view = e.config.view),
            e.metas.add(i, ...null !== (n = e.config.metas) && void 0 !== n ? n : [])
        }(a),
        function(e) {
        ...
        !function(n, i) {
            var r = "function"
                    ...
                    for (n = o = 0; n < f.length && !c && f[n]; )
                        if (c = f[n++].exec(e))
                            for (a = 0; a < p.length; a++)
                                l = c[++o],
                                typeof (u = p[a]) === s && u.length > 0 ? 2 === u.length ? typeof u[1] == r ? this[u[0]] = u[1].call(this, l) : this[u[0]] = u[1] : 3 === u.length ? typeof u[1] !== r || u[1].exec && u[1].test ? this[u[0]] = l ? l.replace(u[1], u[2]) : i : this[u[0]] = l ? u[1].call(this, l, u[2]) : i : 4 === u.length && (this[u[0]] = l ? u[3].call(this, l.replace(u[1], u[2])) : i) : this[u] = l || i;
                    d += 2
                }
            }
              , K = function(e, t) {
              ...
              , Z = function(e, t) {
                ...
                var v = typeof n !== o && n.navigator ? n.navigator : i
                  , b = e || (v && v.userAgent ? v.userAgent : "")
                  , w = v && v.userAgentData ? v.userAgentData : i
                  , y = t ? function(e, t) {
                    var n = {};
                    for (var i in e)
                ...
                return this.getBrowser = function() {
                    ...
                    t[u] = typeof (e = t[p]) === a ? e.replace(/[^\d\.]/g, "").split(".")[0] : i,
                    S && v && v.brave && typeof v.brave.isBrave == r && (t[l] = "Brave"),
                    t
                }
                ,
                ...
                this.getDevice = function() {
                    ...
                    e[d] = i,
                    W.call(e, b, y.device),
                    S && !e[d] && w && w.mobile && (e[d] = m),
                    S && "Macintosh" == e[c] && v && typeof v.standalone !== o && v.maxTouchPoints && v.maxTouchPoints > 2 && (e[c] = "iPad",
                    e[d] = h),
                    e
                }
                ,
                ...
                this.getOS = function() {
                    ...
                    e[p] = i,
                    W.call(e, b, y.os),
                    S && !e[l] && w && w.platform && "Unknown" != w.platform && (e[l] = w.platform.replace(/chrome os/i, F).replace(/macos/i, z)),
                    e
                }
                ,
                ...
                this.setUA = function(e) {
                    return b = typeof e === a && e.length > 500 ? H(e, 500) : e,
                    this
                }
                ,
                this.setUA(b),
    ...
    function je(t) {
        var n, i, r, o;
        return {
            id: null !== (o = null === (r = null === (i = null === (n = e.faro.config) || void 0 === n ? void 0 : n.sessionTracking) || void 0 === i ? void 0 : i.generateSessionId) || void 0 === r ? void 0 : r.call(i)) && void 0 !== o ? o : M(),
            attributes: t
        }
    }
    const _e = {
    ...
    function De(t) {
        ...
        try {
            ...
            return null === (n = e.faro.internalLogger) || void 0 === n || n.info(`Web storage of type ${t} is not available. Reason: ${i}`),
            !1
        }
    }
    function Re(e, t) {
    ...
    function He(e) {
        return o(e) ? e : e instanceof URL ? e.href : !S(e) && c(null == e ? void 0 : e.toString) ? e.toString() : void 0
    }
    const We = "com.grafana.faro.session"
      ...
      , Ze = {
        enabled: !0,
        persistent: !1,
        maxSessionPersistenceTime: Je
    };
    function Ye() {
        var t, n, i;
        const r = e.faro.config.sessionTracking;
        let o = null !== (i = null !== (n = null === (t = null == r ? void 0 : r.sampler) || void 0 === t ? void 0 : t.call(r, {
            metas: e.faro.metas.value
        })) && void 0 !== n ? n : null == r ? void 0 : r.samplingRate) && void 0 !== i ? i : 1;
        if ("number" != typeof o) {
            o = 0
        }
        return Math.random() < o
    }
    function Qe({sessionId: t, started: n, lastActivity: i, isSampled: r=!0}={}) {
        var o, s;
        const a = E()
          , u = null === (s = null === (o = e.faro.config) || void 0 === o ? void 0 : o.sessionTracking) || void 0 === s ? void 0 : s.generateSessionId;
        return null == t && (t = "function" == typeof u ? u() : M()),
        {
            sessionId: t,
    ...
    function tt({fetchUserSession: t, storeUserSession: n}) {
        return function({forceSessionExtend: i}={
            ...
            if (!1 === i && et(c))
                ...
                n(t),
                null === (r = e.faro.api) || void 0 === r || r.setSession(t.sessionMeta),
                null === (o = null == a ? void 0 : a.onSessionChange) || void 0 === o || o.call(a, null !== (s = null == c ? void 0 : c.sessionMeta) && void 0 !== s ? s : null, t.sessionMeta)
            }
        }
    }
    function nt(t, n) {
        ...
        const l = Object.assign(Object.assign({}, t), {
            sessionMeta: {
                id: t.sessionId,
                attributes: Object.assign(Object.assign(Object.assign({}, null === (r = null === (i = e.faro.config.sessionTracking) || void 0 === i ? void 0 : i.session) || void 0 === r ? void 0 : r.attributes), null !== (s = null === (o = e.faro.metas.value.session) || void 0 === o ? void 0 : o.attributes) && void 0 !== s ? s : {}), {
                    isSampled: t.isSampled.toString()
                })
            }
        })
          , d = null !== (u = null === (a = e.faro.metas.value.session) || void 0 === a ? void 0 : a.overrides) && void 0 !== u ? u : null === (c = null == n ? void 0 : n.sessionMeta) || void 0 === c ? void 0 : c.overrides;
        S(d) || (l.sessionMeta.overrides = d);
        const f = null == n ? void 0 : n.sessionId;
        return null != f && (l.sessionMeta.attributes.previousSession = f),
        l
    }
            ...
            if (!!r && s !== (null == o ? void 0 : o.sessionId) || f || d) {
                ...
                function(t, n={}, i={}) {
                    ...
                    const a = n.serviceName
                      , u = null !== (s = null !== (r = i.serviceName) && void 0 !== r ? r : null === (o = e.faro.metas.value.app) || void 0 === o ? void 0 : o.name) && void 0 !== s ? s : "";
                    a && a !== u && e.faro.api.pushEvent(xe, {
                        serviceName: a,
    ...
    class ot {
        ...
        static storeUserSession(e) {
            Ue(We, j(e), ot.storageTypeSession)
        }
        static fetchUserSession() {
    ...
    class at extends ge {
        ...
        sendSessionStartEvent(e) {
            var t, n;
            const i = e.session;
            if (i && i.id !== (null === (t = this.notifiedSession) || void 0 === t ? void 0 : t.id)) {
                if (this.notifiedSession && this.notifiedSession.id === (null === (n = i.attributes) || void 0 === n ? void 0 : n.previousSession))
                    return this.api.pushEvent(Oe, {}, void 0, {
                        skipDedupe: !0
                    }),
                    void (this.notifiedSession = i);
                this.notifiedSession = i,
                this.api.pushEvent(Ie, {}, void 0, {
                    skipDedupe: !0
                })
            }
        }
        createInitialSession(e, t) {
            var n, i, r, o, s, a;
            let u, c, l = e.fetchUserSession();
            if (t.persistent && t.maxSessionPersistenceTime && l) {
                const e = E();
                l.lastActivity < e - t.maxSessionPersistenceTime && (rt.removeUserSession(),
                l = null)
            }
            if (et(l)) {
                ...
                const r = null == l ? void 0 : l.sessionMeta
                  , o = Object.assign(Object.assign({}, null === (n = t.session) || void 0 === n ? void 0 : n.overrides), null == r ? void 0 : r.overrides);
                c.sessionMeta = Object.assign(Object.assign({}, t.session), {
                    id: e,
                    attributes: Object.assign(Object.assign(Object.assign({}, null === (i = t.session) || void 0 === i ? void 0 : i.attributes), null == r ? void 0 : r.attributes), {
                ...
                const e = null !== (o = null === (r = t.session) || void 0 === r ? void 0 : r.id) && void 0 !== o ? o : je().id;
                c = Qe({
                    sessionId: e,
                    isSampled: Ye()
                });
                const n = null === (s = t.session) || void 0 === s ? void 0 : s.overrides;
        ...
        registerBeforeSendHook(e) {
            ...
            null === (t = this.transports) || void 0 === t || t.addBeforeSendHooks((e => {
                var t, i, r;
                n();
                const o = null === (t = e.meta.session) || void 0 === t ? void 0 : t.attributes;
                if (o && "true" === (null == o ? void 0 : o.isSampled)) {
                    let t = JSON.parse(JSON.stringify(e));
                    const n = null === (i = t.meta.session) || void 0 === i ? void 0 : i.attributes;
                    return null == n || delete n.isSampled,
                    0 === Object.keys(null != n ? n : {}).length && (null === (r = t.meta.session) || void 0 === r || delete r.attributes),
                    t
                }
                return null
            }
        ...
        initialize() {
            ...
            if (null == e ? void 0 : e.enabled) {
                ...
                const {initialSession: n, lifecycleType: i} = this.createInitialSession(t, e);
                t.storeUserSession(n);
                const r = n.sessionMeta;
                this.notifiedSession = r,
                this.api.setSession(r),
                i === Ie && this.api.pushEvent(Ie, {}, void 0, {
                    skipDedupe: !0
                }),
                i === ke && this.api.pushEvent(ke, {}, void 0, {
                    skipDedupe: !0
                })
            }
    ...
    const ut = "DOMError"
      ...
      , dt = "?"
      , ft = /^(?:[Uu]ncaught (?:exception: )?)?(?:((?:Eval|Internal|Range|Reference|Syntax|Type|URI|)Error): )?(.*)$/i;
    const pt = "\n"
      , gt = "eval"
      , vt = "?"
      , mt = "@"
      , ht = /^\s*at (?:(.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i
      , bt = /\((\S*)(?::(\d+))(?::(\d+))\)/
      , wt = "eval"
      , yt = "address at "
      , St = yt.length
      , Tt = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension|safari-extension|safari-web-extension|capacitor)?:\/.*?|\[native code]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i
    ...
    function Ct(e, t) {
        ...
        return n || i ? [(null == e ? void 0 : e.includes(mt)) ? e.split(mt)[0] : e, n ? `${kt}:${t}` : `${Ot}:${t}`] : [e, t]
    }
    function At(e) {
        let t = [];
        e.stacktrace ? t = e.stacktrace.split(pt).filter(( (e, t) => t % 2 == 0)) : e.stack && (t = e.stack.split(pt));
        const n = t.reduce(( (t, n, i) => {
            ...
            if (r = ht.exec(n)) {
                ...
                a && a.includes(It)) {
                    ...
                    0 === i && !c && s(e.columnNumber) && (c = String(e.columnNumber + 1));
                [o,a] = Ct(o, a)
            }
            return (a || o) && t.push(Lt(a, o, u ? Number(u) : void 0, c ? Number(c) : void 0)),
            t
        }
        ), []);
    ...
    function Mt(e) {
        ...
        if (m(e) && e.error)
            ...
            v(e) ? (t = e.message,
            o = At(e)) : (u(e) || (r = p(e))) && (n = r ? e.constructor.name : void 0,
            t = `${lt} ${Object.keys(e)}`);
        return [t, n, o]
    }
    function Nt(e) {
        ...
        const l = o(t)
          , d = Lt(n, dt, i, r);
        return s || !l ? ([a,u,c] = Mt(null != s ? s : t),
        0 === c.length && (c = [d])) : l && ([a,u] = function(e) {
            var t, n;
            const i = e.match(ft)
              , r = null !== (t = null == i ? void 0 : i[1]) && void 0 !== t ? t : oe;
            return [null !== (n = null == i ? void 0 : i[2]) && void 0 !== n ? n : e, r]
        }(t),
        c = [d]),
        {
            value: a,
    ...
    class _t extends ge {
        ...
        initialize() {
            ...
            const o = (null === (t = this.options) || void 0 === t ? void 0 : t.serializeErrors) || !!(null === (n = this.options) || void 0 === n ? void 0 : n.errorSerializer);
            this.errorSerializer = o ? null !== (r = null === (i = this.options) || void 0 === i ? void 0 : i.errorSerializer) && void 0 !== r ? r : se : ce,
            L.filter((e => {
                var t, n;
                return !(null !== (n = null === (t = this.options) || void 0 === t ? void 0 : t.disabledLevels) && void 0 !== n ? n : _t.defaultDisabledLevels).includes(e)
            }
            )).forEach((t => {
                console[t] = (...n) => {
                    var i, r;
                    try {
                        if (t !== e.LogLevel.ERROR || (null === (i = this.options) || void 0 === i ? void 0 : i.consoleErrorAsLog))
                            if (t === e.LogLevel.ERROR && (null === (r = this.options) || void 0 === r ? void 0 : r.consoleErrorAsLog)) {
                                const {value: e, type: i, stackFrames: r} = jt(n, this.errorSerializer);
                            ...
                            const {value: e, type: t, stackFrames: i} = jt(n, this.errorSerializer);
                            if (e && !t && !i)
                                return void this.api.pushError(new Error(_t.consoleErrorPrefix + e));
    ...
    _t.defaultDisabledLevels = [e.LogLevel.DEBUG, e.LogLevel.TRACE, e.LogLevel.LOG],
    ...
    class Dt extends ge {
        ...
        initialize() {
            ...
            function(e) {
                ...
                window.onerror = (...n) => {
                    try {
                        const {value: t, type: i, stackFrames: r} = Nt(n)
                          , o = n[4];
                        if (t) {
                            const n = {
                                type: i,
            ...
            window.addEventListener("unhandledrejection", (t => {
                var n, i;
                let r, o, s = t;
                s.reason ? s = t.reason : (null === (n = t.detail) || void 0 === n ? void 0 : n.reason) && (s = null === (i = t.detail) || void 0 === i ? void 0 : i.reason);
                let a = [];
                d(s) ? (r = `Non-Error promise rejection captured with value: ${String(s)}`,
                o = "UnhandledRejection") : [r,o,a] = Mt(s),
                r && e.pushError(new Error(r), {
                    type: o,
                    stackFrames: a
                })
            }
    ...
    class Rt extends ge {
        ...
        sendViewChangedEvent(e) {
            var t, n, i, r;
            const o = e.view;
            o && o.name !== (null === (t = this.notifiedView) || void 0 === t ? void 0 : t.name) && (this.api.pushEvent(Ee, {
                fromView: null !== (i = null === (n = this.notifiedView) || void 0 === n ? void 0 : n.name) && void 0 !== i ? i : Le,
    ...
    var Ut, Bt, Ft, zt, qt, Vt = -1, $t = function(e) {
        addEventListener("pageshow", (function(t) {
            t.persisted && (Vt = t.timeStamp,
            e(t))
        }
        ), !0)
    }, Gt = function() {
        ...
        var n = Gt()
          , i = "navigate";
        return Vt >= 0 ? i = "back-forward-cache" : n && (document.prerendering || Ht() > 0 ? i = "prerender" : document.wasDiscarded ? i = "restore" : n.type && (i = n.type.replace(/_/g, "-"))),
        {
            name: e,
            value: void 0 === t ? -1 : t,
            rating: "good",
        ...
        "hidden" === document.visibilityState && Qt > -1 && (Qt = "visibilitychange" === e.type ? e.timeStamp : 0,
        rn())
    }, nn = function() {
    ...
    }, an = [1800, 3e3], un = function(e, t) {
        t = t || {},
        sn((function() {
            var n, i = on(), r = Wt("FCP"), o = Kt("paint", (function(e) {
                e.forEach((function(e) {
                    "first-contentful-paint" === e.name && (o.disconnect(),
                    e.startTime < i.firstHiddenTime && (r.value = Math.max(e.startTime - Ht(), 0),
                    r.entries.push(e),
                    n(!0)))
                }
                ))
            ...
            o && (n = Xt(e, r, an, t.reportAllChanges),
            $t((function(i) {
                r = Wt("FCP"),
    ...
    }, cn = [.1, .25], ln = 0, dn = 1 / 0, fn = 0, pn = function(e) {
        e.forEach((function(e) {
            e.interactionId && (dn = Math.min(dn, e.interactionId),
    ...
    }, vn = [], mn = new Map, hn = 0, bn = [], wn = function(e) {
        if (bn.forEach((function(t) {
            return t(e)
        }
        )),
        e.interactionId || "first-input" === e.entryType) {
            var t = vn[vn.length - 1]
              , n = mn.get(e.interactionId);
            if (n || vn.length < 10 || e.duration > t.latency) {
                if (n)
                ...
                vn.sort((function(e, t) {
                    return t.latency - e.latency
                }
                )),
                vn.length > 10 && vn.splice(10).forEach((function(e) {
                    return mn.delete(e.id)
                }
                ))
            }
        }
        ...
        Zt(e)),
        n
    }, Sn = [200, 500], Tn = [2500, 4e3], En = {}, In = [800, 1800], kn = function e(t) {
        document.prerendering ? sn((function() {
            return e(t)
        }
        ...
        passive: !0,
        capture: !0
    }, xn = new Date, Ln = function(e, t) {
        Bt || (Bt = t,
        Ft = e,
        zt = new Date,
        Pn(removeEventListener),
        Cn())
    }, Cn = function() {
        if (Ft >= 0 && Ft < zt - xn) {
            var e = {
    ...
    class Nn {
        constructor(e, t) {
            this.pushMeasurement = e,
            this.webVitalConfig = t
        }
        initialize() {
            Object.entries(Nn.mapping).forEach(( ([e,t]) => {
                var n;
                t((t => {
                    ...
                    reportAllChanges: null === (n = this.webVitalConfig) || void 0 === n ? void 0 : n.reportAllChanges
                })
            }
            ))
        }
    ...
    Nn.mapping = {
        cls: function(e, t) {
            t = t || {},
            un(Yt((function() {
                var n, i = Wt("CLS", 0), r = 0, o = [], s = function(e) {
                    e.forEach((function(e) {
                        if (!e.hadRecentInput) {
                            var t = o[0]
                              , n = o[o.length - 1];
                            r && e.startTime - n.startTime < 1e3 && e.startTime - t.startTime < 5e3 ? (r += e.value,
                            o.push(e)) : (r = e.value,
                            o = [e])
                        }
                    }
                ...
                a && (n = Xt(e, i, cn, t.reportAllChanges),
                Zt((function() {
                    s(a.takeRecords()),
                    n(!0)
                }
        ...
        fid: function(e, t) {
            t = t || {},
            sn((function() {
                var n, i = on(), r = Wt("FID"), o = function(e) {
                    e.startTime < i.firstHiddenTime && (r.value = e.processingStart - e.startTime,
                    r.entries.push(e),
                    n(!0))
                }, s = function(e) {
                    e.forEach(o)
        ...
        inp: function(e, t) {
            ...
            sn((function() {
                var n;
                "interactionCount"in performance || Ut || (Ut = Kt("event", pn, {
                    type: "event",
                    buffered: !0,
                    durationThreshold: 0
                }));
                var i, r = Wt("INP"), o = function(e) {
                    yn((function() {
                        e.forEach(wn);
                        var t = function() {
                            var e = Math.min(vn.length - 1, Math.floor((gn() - hn) / 50));
                            return vn[e]
                        }();
        ...
        lcp: function(e, t) {
            t = t || {},
            sn((function() {
                var n, i = on(), r = Wt("LCP"), o = function(e) {
        ...
        ttfb: function(e, t) {
            ...
            kn((function() {
                var r = Gt();
                r && (n.value = Math.max(r.responseStart - Ht(), 0),
                n.entries = [r],
                i(!0),
                $t((function() {
                    n = Wt("TTFB", 0),
                    (i = Xt(e, n, In, t.reportAllChanges))(!0)
                }
                )))
            }
            ))
    ...
    var jn, _n, Dn = function() {
        ...
        try {
            for (; e && 9 !== e.nodeType; ) {
                var i = e
                  , r = i.id ? "#" + i.id : Un(i) + (i.classList && i.classList.value && i.classList.value.trim() && i.classList.value.trim().length ? "." + i.classList.value.trim().replace(/\s+/g, ".") : "");
        ...
        var n = Dn()
          , i = "navigate";
        return zn() >= 0 ? i = "back-forward-cache" : n && (document.prerendering || Vn() > 0 ? i = "prerender" : document.wasDiscarded ? i = "restore" : n.type && (i = n.type.replace(/_/g, "-"))),
        {
            name: e,
            value: void 0 === t ? -1 : t,
            rating: "good",
        ...
        "hidden" === document.visibilityState && Jn > -1 && (Jn = "visibilitychange" === e.type ? e.timeStamp : 0,
        ei())
    }, Qn = function() {
    ...
    }, ii = [1800, 3e3], ri = function(e, t) {
        t = t || {},
        ni((function() {
            var n, i = ti(), r = $n("FCP"), o = Gn("paint", (function(e) {
                e.forEach((function(e) {
                    "first-contentful-paint" === e.name && (o.disconnect(),
                    e.startTime < i.firstHiddenTime && (r.value = Math.max(e.startTime - Vn(), 0),
                    r.entries.push(e),
                    n(!0)))
                }
                ))
            ...
            o && (n = Hn(e, r, ii, t.reportAllChanges),
            qn((function(i) {
                r = $n("FCP"),
    ...
    }, oi = [.1, .25], si = 0, ai = 1 / 0, ui = 0, ci = function(e) {
        e.forEach((function(e) {
            e.interactionId && (ai = Math.min(ai, e.interactionId),
            ui = Math.max(ui, e.interactionId),
            si = ui ? (ui - ai) / 7 + 1 : 0)
        }
        ))
    }, li = function() {
        return jn ? si : performance.interactionCount || 0
    }, di = function() {
        "interactionCount"in performance || jn || (jn = Gn("event", ci, {
            type: "event",
            buffered: !0,
            durationThreshold: 0
        }))
    }, fi = [], pi = new Map, gi = 0, vi = [], mi = function(e) {
        if (vi.forEach((function(t) {
            return t(e)
        }
        )),
        e.interactionId || "first-input" === e.entryType) {
            ...
            if (n || fi.length < 10 || e.duration > t.latency) {
                ...
                fi.length > 10 && fi.splice(10).forEach((function(e) {
        ...
        Kn(e)),
        n
    }, bi = [200, 500], wi = function(e, t) {
        "PerformanceEventTiming"in self && "interactionId"in PerformanceEventTiming.prototype && (t = t || {},
        ni((function() {
            var n;
            di();
            var i, r = $n("INP"), o = function(e) {
                hi((function() {
                    e.forEach(mi);
                    var t = function() {
    ...
    }, yi = [], Si = [], Ti = 0, Ei = new WeakMap, Ii = new Map, ki = -1, Oi = function(e) {
        yi = yi.concat(e),
        xi()
    }, xi = function() {
        ki < 0 && (ki = hi(Li))
    }, Li = function() {
        Ii.size > 10 && Ii.forEach((function(e, t) {
        ...
        for (var n = new Set, i = 0; i < Si.length; i++) {
            var r = Si[i];
            Ni(r.startTime, r.processingEnd).forEach((function(e) {
                n.add(e)
            }
            ))
        }
    ...
    vi.push((function(e) {
        e.interactionId && e.target && !Ii.has(e.interactionId) && Ii.set(e.interactionId, e.target)
    }
    ), (function(e) {
    ...
    var Ci, Ai, Pi, Mi, Ni = function(e, t) {
        ...
        return i
    }, ji = [2500, 4e3], _i = {}, Di = [800, 1800], Ri = function e(t) {
        document.prerendering ? ni((function() {
            return e(t)
        }
        )) : "complete" !== document.readyState ? addEventListener("load", (function() {
            return e(t)
        ...
        Ri((function() {
            var r = Dn();
            r && (n.value = Math.max(r.responseStart - Vn(), 0),
            n.entries = [r],
            i(!0),
            qn((function() {
                n = $n("TTFB", 0),
                (i = Hn(e, n, Di, t.reportAllChanges))(!0)
            }
            )))
        }
        ))
    ...
    }, Gi = [100, 300], Hi = function(e, t) {
        !function(e, t) {
            t = t || {},
            ni((function() {
                var n, i = ti(), r = $n("FID"), o = function(e) {
                    e.startTime < i.firstHiddenTime && (r.value = e.processingStart - e.startTime,
                    r.entries.push(e),
                    n(!0))
                }, s = function(e) {
    ...
    class Ji {
        ...
        measureCLS() {
            ...
            !function(e, t) {
                !function(e, t) {
                    t = t || {},
                    ri(Xn((function() {
                        var n, i = $n("CLS", 0), r = 0, o = [], s = function(e) {
                            e.forEach((function(e) {
                                if (!e.hadRecentInput) {
                                    var t = o[0]
                                      , n = o[o.length - 1];
                        ...
                        a && (n = Hn(e, i, oi, t.reportAllChanges),
                        Kn((function() {
                            s(a.takeRecords()),
                            n(!0)
                        }
                ...
                const {loadState: t, largestShiftValue: n, largestShiftTime: i, largestShiftTarget: r} = e.attribution
                ...
                reportAllChanges: null === (e = this.webVitalConfig) || void 0 === e ? void 0 : e.reportAllChanges
            })
        }
        measureFCP() {
            var e;
            !function(e, t) {
                ...
                const {firstByteToFCP: t, timeToFirstByte: n, loadState: i} = e.attribution
        ...
        measureFID() {
            var e;
            Hi((e => {
                const {eventTime: t, eventTarget: n, eventType: i, loadState: r} = e.attribution
                  , o = this.buildInitialValues(e);
        ...
        measureINP() {
            ...
            !function(e, t) {
                ...
                wi((function(t) {
                    var n = function(e) {
                        var t = e.entries[0]
                          ...
                          , c = [t.startTime + t.duration, r].concat(s.map((function(e) {
                ...
                const {interactionTime: t, presentationDelay: n, inputDelay: i, processingDuration: r, nextPaintTime: o, loadState: s, interactionTarget: a, interactionType: u} = e.attribution
        ...
        measureLCP() {
            ...
            !function(e, t) {
                !function(e, t) {
                    t = t || {},
                    ni((function() {
                        var n, i = ti(), r = $n("LCP"), o = function(e) {
                            t.reportAllChanges || (e = e.slice(-1)),
                            e.forEach((function(e) {
                                e.startTime < i.firstHiddenTime && (r.value = Math.max(e.startTime - Vn(), 0),
                                r.entries = [e],
                        ...
                        if (s) {
                            n = Hn(e, r, ji, t.reportAllChanges);
                            var a = Xn((function() {
                                _i[r.id] || (o(s.takeRecords()),
                                s.disconnect(),
                                _i[r.id] = !0,
                                n(!0))
                            }
                ...
                const {elementRenderDelay: t, resourceLoadDelay: n, resourceLoadDuration: i, timeToFirstByte: r, element: o} = e.attribution
        ...
        measureTTFB() {
            ...
            !function(e, t) {
                ...
                const {dnsDuration: t, connectionDuration: n, requestDuration: i, waitingDuration: r, cacheDuration: o} = e.attribution
                  , s = this.buildInitialValues(e);
    ...
    class Zi extends ge {
        ...
        intializeWebVitalsInstrumentation() {
            var e, t, n;
            return !1 === (null === (e = this.config) || void 0 === e ? void 0 : e.trackWebVitalsAttribution) || !1 === (null === (n = null === (t = this.config) || void 0 === t ? void 0 : t.webVitalsInstrumentation) || void 0 === n ? void 0 : n.trackAttribution) ? new Nn(this.api.pushMeasurement,this.config.webVitalsInstrumentation) : new Ji(this.api.pushMeasurement,this.config.webVitalsInstrumentation)
        }
    }
    function Yi(e, t) {
        var n = {};
    ...
    function rr(e) {
        const {connectEnd: t, connectStart: n, decodedBodySize: i, domainLookupEnd: r, domainLookupStart: o, duration: s, encodedBodySize: a, fetchStart: u, initiatorType: c, name: l, nextHopProtocol: d, redirectEnd: f, redirectStart: p, renderBlockingStatus: g, requestStart: v, responseEnd: m, responseStart: h, responseStatus: b, secureConnectionStart: w, transferSize: y, workerStart: S} = e;
        return {
            name: l,
            duration: sr(s),
            ...
            cacheHitStatus: function() {
                let e = "fullLoad";
                0 === y ? i > 0 && (e = "cache") : null != b ? 304 === b && (e = "conditionalFetch") : a > 0 && y < a && (e = "conditionalFetch");
                return e
            }(),
    ...
    function or(e) {
        const {activationStart: t, domComplete: n, domContentLoadedEventEnd: i, domContentLoadedEventStart: r, domInteractive: o, fetchStart: s, loadEventEnd: a, loadEventStart: u, responseStart: c, type: l} = e
          , d = function() {
            var e;
            if (null != (null === (e = performance.timing) || void 0 === e ? void 0 : e.domLoading))
    ...
    function sr(e) {
        return null == e ? Le : "number" == typeof e ? Math.round(e > 0 ? e : 0).toString() : e.toString()
    }
    const ar = {
    ...
    class cr extends ge {
        ...
        initialize() {
            "PerformanceObserver"in window ? function(e) {
                ...
                const t = this.api.pushEvent
                  , {faroNavigationId: n} = yield function(e) {
                    ...
                    return new PerformanceObserver((n => {
                        ...
                        const a = null !== (i = Re(Wi, _e.session)) && void 0 !== i ? i : Le
                        ...
                        e("faro.performance.navigation", u, void 0, {
                            spanContext: s,
                            timestampOverwriteMs: performance.timeOrigin + o.startTime
                        }),
                        t(u)
                    }
                    )).observe({
                    ...
                    new PerformanceObserver((o => {
                        ...
                        for (const o of s) {
                            ...
                            if (null == r && ir(s, ar) || r) {
                                ...
                                e.faro.config.trackUserActionsPreview && (null == i || i.notify({
                                    type: er
                                })),
    ...
    function br() {
        ...
        return function({onRequestEnd: e, onRequestStart: t}) {
            ...
            window.fetch = function() {
                ...
                n.apply(this, arguments).then((t => (s || e({
                    url: o,
                    method: a,
                    requestId: u,
                    apiType: mr
    ...
    function wr(e) {
        const {api: t, config: n} = e
          ...
          , r = function() {
            const e = new D;
            return new MutationObserver(( (t, n) => {
                e.notify({
                    type: pr
                })
            }
        ...
        return function(e) {
            var u;
            let c;
            const l = (d = e).type === vr && "string" == typeof d.name;
            var d;
            if (c = l ? e.name : function(e, t) {
                const n = function(e) {
                    const t = e.split("data-")[1]
                      , n = null == t ? void 0 : t.replace(/-(.)/g, ( (e, t) => t.toUpperCase()));
                ...
                for (const e in i)
                    if (e === n)
                        return i[e];
                return
            }(e.target, null !== (u = n.trackUserActionsDataAttributeName) && void 0 !== u ? u : "faroUserActionName"),
            a || null == c)
                return;
            a = !0;
            const f = E();
            ...
            const v = new Map;
            let m, h = !1;
            const b = (new D).merge(i, r, o).takeWhile(( () => a)).filter((e => !!(!h || Er(e) && v.has(e.request.requestId)))).subscribe((n => {
                (function(e) {
                    return e.type === dr
                }
                )(n) && v.set(n.request.requestId, n.request),
                Er(n) && v.delete(n.request.requestId),
                s = Sr(s, ( () => {
                    p = E();
    ...
    function yr(e) {
        const {api: t, userActionName: n, startTime: i, endTime: r, actionId: o, event: s, attributes: a} = e
          , u = r - i
          , c = s.type;
        fe.notify({
            type: ne,
    ...
    class kr extends ge {
        ...
        initialize() {
            Ir = wr(e.faro),
            window.addEventListener("pointerdown", Ir),
            window.addEventListener("keydown", Ir)
        }
    }
    class Or extends ge {
        constructor() {
        ...
        securitypolicyviolationHandler(e) {
            this.api.pushEvent("securitypolicyviolation", _(e))
        }
    }
    function xr(e={}) {
        const t = [new kr, new Dt, new Zi, new at, new Rt];
        return !1 !== e.enablePerformanceInstrumentation && t.unshift(new cr),
        !1 !== e.enableContentSecurityPolicyInstrumentation && t.push(new Or),
        !1 !== e.captureConsole && t.push(new _t({
    ...
    ;
    let Ar, Pr;
    function Mr({generatePageId: e, initialPageMeta: t}={}) {
        return () => {
            const n = location.href;
            return c(e) && Ar !== n && (Ar = n,
            Pr = e(location)),
            {
    ...
    class Nr extends Y {
        constructor(e) {
            ...
            this.rateLimitBackoffMs = null !== (t = e.defaultRateLimitBackoffMs) && void 0 !== t ? t : 5e3,
            this.getNow = null !== (n = e.getNow) && void 0 !== n ? n : () => Date.now(),
            ...
            return Qi(this, void 0, void 0, (function*() {
                try {
                    ...
                    yield this.promiseBuffer.add(( () => {
                        ...
                        }, null != a ? a : {})).then((e => Qi(this, void 0, void 0, (function*() {
                            if (202 === e.status) {
                                "invalid" === e.headers.get("X-Faro-Session-Status") && this.extendFaroSession(this.config, this.logDebug)
                            }
                            return 429 === e.status && (this.disabledUntil = this.getRetryAfterDate(e),
        ...
        getIgnoreUrls() {
            var e;
            return [this.options.url].concat(null !== (e = this.config.ignoreUrls) && void 0 !== e ? e : [])
        }
        isBatched() {
            return !0
        }
    ...
    function jr(e) {
        ...
        e.transports ? ((e.url || e.apiKey) && i.error('if "transports" is defined, "url" and "apiKey" should not be defined'),
        n.push(...e.transports)) : e.url ? n.push(new Nr({
            url: e.url,
            apiKey: e.apiKey
        })) : i.error('either "url" or "transports" must be defined');
        const {dedupe: r=!0, eventDomain: o=Lr, globalObjectKey: s=Se, instrumentations: a=xr(), internalLoggerLevel: u=$, isolate: c=!1, logArgsSerializer: l=ce, metas: d=Dr(e), paused: f=!1, preventGlobalExposure: p=!1, unpatchedConsole: g=G, trackUserActionsPreview: v=!1, trackUserActionsDataAttributeName: m=gr, url: h} = e
          , b = Yi(e, ["dedupe", "eventDomain", "globalObjectKey", "instrumentations", "internalLoggerLevel", "isolate", "logArgsSerializer", "metas", "paused", "preventGlobalExposure", "unpatchedConsole", "trackUserActionsPreview", "trackUserActionsDataAttributeName", "url"]);
        return Object.assign(Object.assign({}, b), {
            batching: Object.assign(Object.assign({}, Te), e.batching),
            dedupe: r,
            globalObjectKey: s,
            instrumentations: _r(a, e),
            ...
            unpatchedConsole: g,
            eventDomain: o,
            ignoreUrls: [...null !== (t = e.ignoreUrls) && void 0 !== t ? t : [], ...h ? [h] : [], /\/collect(?:\/[\w]*)?$/],
            sessionTracking: Object.assign(Object.assign(Object.assign({}, Ze), e.sessionTracking), Rr({
                trackGeolocation: e.trackGeolocation,
                sessionTracking: e.sessionTracking
            })),
            trackUserActionsPreview: v,
            trackUserActionsDataAttributeName: m
        })
    }
    function _r(e, {trackUserActionsPreview: t}) {
        return e.filter((e => !("@grafana/faro-web-sdk:instrumentation-user-action" === e.name && !t)))
    }
    function Dr(e) {
        var t, n;
        const {page: i, generatePageId: r} = null !== (t = null == e ? void 0 : e.pageTracking) && void 0 !== t ? t : {}
          , o = [Ne, Mr({
            generatePageId: r,
            initialPageMeta: i
        }), ...null !== (n = e.metas) && void 0 !== n ? n : []];
        return u(window.k6) ? [...o, Cr] : o
    }
    function Rr({trackGeolocation: e, sessionTracking: t}) {
        var n;
        const i = {};
        return a(e) && (i.geoLocationTrackingEnabled = e),
        S(i) ? {} : {
            session: Object.assign(Object.assign({}, null !== (n = null == t ? void 0 : t.session) && void 0 !== n ? n : {}), {
                overrides: i
            })
        }
    }
    return e.BaseExtension = Z,
    e.BaseInstrumentation = ge,
    e.BaseTransport = Y,
    e.CSPInstrumentation = Or,
    ...
    e.ConsoleTransport = class extends Y {
        ...
        send(t) {
            var n;
            return this.unpatchedConsole[null !== (n = this.options.level) && void 0 !== n ? n : e.LogLevel.DEBUG]("New event", ee([t]))
        }
    }
    ,
    e.Conventions = {
    ...
    e.USER_ACTION_HALT = re,
    e.USER_ACTION_START = te,
    e.UserActionInstrumentation = kr,
    e.VERSION = ve,
    ...
    e.isSyntheticEvent = e => u(e) && "nativeEvent"in e && "preventDefault"in e && "stopPropagation"in e,
    ...
    e.sdkMeta = () => ({
        sdk: {
            ...
            version: ve,
            integrations: e.faro.config.instrumentations.map(( ({name: e, version: t}) => ({
                name: e,
                version: t
            })))
        }
